CREATE OR REPLACE VIEW `project-0e230ae7-fb71-4b05-bba.user_events.v_funnel_counts` AS
...
CREATE OR REPLACE VIEW `project-0e230ae7-fb71-4b05-bba.user_events.v_funnel_rates` AS
WITH funnel_stages AS (
  SELECT
    COUNT(DISTINCT CASE WHEN event_type = 'page_view'       THEN user_id END) AS stage_1_view,
    COUNT(DISTINCT CASE WHEN event_type = 'add_to_cart'     THEN user_id END) AS stage_2_cart,
...
--- funnel by source
CREATE OR REPLACE VIEW `project-0e230ae7-fb71-4b05-bba.user_events.v_funnel_by_source` AS
...
--- time to conversion
CREATE OR REPLACE VIEW `project-0e230ae7-fb71-4b05-bba.user_events.v_time_to_conversion` AS
...
--- revenue funnel
CREATE OR REPLACE VIEW `project-0e230ae7-fb71-4b05-bba.user_events.v_revenue_funnel` AS
